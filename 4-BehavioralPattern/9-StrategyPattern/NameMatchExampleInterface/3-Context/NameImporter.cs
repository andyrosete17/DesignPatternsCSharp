namespace NameMatchExampleInterface_3_Context
{
    using System;
    ...
    public class NameImporter
    {
        ...
        private INameComparer _comparer;

        /// <summary>
        /// Initializes a new instance of the <see cref="NameMatchExampleInterface.NameImporter"/> class.
        /// </summary>
