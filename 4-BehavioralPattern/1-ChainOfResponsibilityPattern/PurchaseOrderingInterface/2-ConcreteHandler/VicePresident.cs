namespace PurchaseOrderingInterface_2_ConcreteHandler
{
    ...
    /// </summary>
    internal class VicePresident : IPOApprover
    {
        public IPOApprover _successor { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="PurchaseOrderingInterface.VicePresident"/> class.
        /// </summary>
        /// <param name="successor">The successor in the chain of handlers.</param>
        public VicePresident(IPOApprover successor)
        {
